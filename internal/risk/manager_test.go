...
func (m *mockTrader) SetMarketSpecService(svc trading.MarketSpecService)            {}
...
func TestCheckTradeAmount(t *testing.T) {
	...
	rm := NewRiskManager(riskCfg, tradingCfg, nil, nil, nil, nil)
...
func TestCheckDailyTradeLimit(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			rm := NewRiskManager(riskCfg, nil, tradingRepo, nil, nil, nil)
...
func TestCheckTotalLossLimit(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			rm := NewRiskManager(riskCfg, tradingCfg, nil, analyticsRepo, trader, nil)
...
func TestCheckRiskManagement(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			analyticsRepo := &mockAnalyticsRepo{metrics: tt.metrics}
			trader := &mockTrader{balances: tt.balances}
			rm := NewRiskManager(riskCfg, tradingCfg, tradingRepo, analyticsRepo, trader, nil)
