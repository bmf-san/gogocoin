...
import (
	...
	appconfig "github.com/bmf-san/gogocoin/v1/internal/config"
...
// Strategy interface is now defined in interfaces.go
// This file contains the implementation types and helper structs
...
func (sf *StrategyFactory) createScalping(config interface{}) (Strategy, error) {
	...
	defaultConfig := appconfig.ScalpingParams{
	...
	if config != nil {
		if params, ok := config.(appconfig.ScalpingParams); ok {
